$(document).ready(function ()
{
    ...
    function UpdateDemande()
    {
        ...
        if (validation['resultat'] === true)
        {
            ...
            var route = Routing.generate('_update_demande', {'idDemande': idDemande});
            var redirect_route = Routing.generate('_index_demandes_utilisateur');
    ...
    function Submit()
    {
        ...
        if (validation['resultat'] === true)
        {
            ...
            var route = Routing.generate('_nouvelle_demande');
            var redirect_route = Routing.generate('_index_demandes_utilisateur');
            $("#loadingResponse").toggle();
            $('#reponse').html("<span style='color:orange'>Enregistrement en cours...</span>");
